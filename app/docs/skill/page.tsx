...
skill = httpx.get("https://krabs.dev/skill.md").text`}</pre>
          ...
          <ul>
            ...
            <li>
              The 7 primitives (<code>contact</code>, <code>identity</code>, <code>interaction</code>,{" "}
              <code>deal</code>, <code>task</code>, <code>note</code>, <code>tag</code>) with id
              prefixes.
            </li>
            <li>
              How to mint and rotate auth tokens. Where to send the user for the device flow when
              the agent doesn&apos;t have one.
            </li>
            <li>
              The five contract guarantees: intent, idempotency, dry-run, schema introspection,
              reversible audit.
            </li>
            <li>Common operations with concrete commands (upsert, attach identity, create deal, undo).</li>
            <li>
