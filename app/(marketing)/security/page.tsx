    ...
    <main style={{ padding: "80px 32px 120px" }}>
      <article style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        >
          ...
          <Section
            title="Data at rest"
            body="Tokens and PII are encrypted at the column level. Storage is SQLite via libSQL/Turso with per-tenant database isolation — your rows live in a database other tenants cannot reach."
          />

          <Section
            title="Authentication"
            body="Clerk handles human auth. Agents authenticate with bearer keys. Keys are shown once at creation and stored hashed at rest — if you lose one, you rotate, you don't recover."
          />
