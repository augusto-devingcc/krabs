  ...
  return (
    ...
    >
      ...
      <p className="mk-sub" style={{ maxWidth: 640 }}>
        ...
        because the CRM I needed to run my own business with agents did not
        exist.
      </p>
    </section>
  );
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
          ...
          <Block heading="why krabs">
            <p>
              I run my own business with agents. Every CRM I tried assumed the
              operator was a human clicking through pages — so I kept writing
              adapters to make HubSpot, Salesforce and friends agent-shaped.
            </p>
            <p>
